...
= 1.1.4 =
* Fixed and integration issue for the Accept Stripe Payments plugin.

= 1.1.3 =
* Improved the bbPress turnstile integration so it can work seamlessly on classic themes.
